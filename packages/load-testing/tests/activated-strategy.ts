...
test("[Percentage activation authenticated]: 25% of the people should receive the activated variant when activating it WEBSOCKET UPDATES", async (browsers, config) => {
  await browsers.open("http://localhost:3000");
