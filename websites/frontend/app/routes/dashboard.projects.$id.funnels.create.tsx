...
import { getDistinctEventNames } from "~/modules/events/services/getDistinctEventNames";
import { getDistinctUrl } from "~/modules/events/services/getDistinctUrl";
...
export const loader: LoaderFunction = async ({ request, params }) => {
  ...
  const [flags, eventNames, pageViewUrls] = await Promise.all([
    ...
    getDistinctEventNames(projectId, day, authCookie),
    getDistinctUrl(projectId, day, authCookie),
  ]);
