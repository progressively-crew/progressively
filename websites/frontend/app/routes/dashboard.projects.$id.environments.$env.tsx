...
export const handle = {
  breadcrumb: (match, matches: any) => {
    ...
    return {
      ...
      isEnv: true,
      menuItems: [
        ...parentProjectMatch.data.project.environments.map((env) => {
          ...
          const href =
            nextPath.at(-1) === "/" ? nextPath.slice(0, -1) : nextPath;
        ...
        {
          label: "Add an env",
          href: `/dashboard/projects/${parentProjectMatch.data.project.uuid}/environments/create`,
          icon: <AiOutlinePlus />,
        },
      ],
