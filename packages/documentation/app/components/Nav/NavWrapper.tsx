  ...
  return (
    <li>
      <NavLink
        ...
        className={({ isActive }) =>
          isActive
            ? "h-8 block flex items-center lg:rounded px-4 bg-indigo-700 font-bold text-white lg:bg-indigo-100 lg:text-indigo-700 dark:bg-slate-600 lg:dark:text-slate-100 text-sm"
