describe("/dashboard/projects/[id]/flags/[flagId]/webhooks/create", () => {
  before(cy.seed);
  after(cy.cleanupDb);

  describe("not authenticated", () => {
    beforeEach(() => {
      cy.visit("/dashboard/projects/1/flags/1/webhooks/create");
    });
  ...
  describe("authenticated", () => {
    ...
    describe("user: Marvin", () => {
      ...
      it.skip("creates a webhook", () => {
        cy.findByLabelText("Endpoint:")
          .should("be.visible")
          .type("https://something.com");

        cy.findByLabelText("Event:").click();
        cy.findByLabelText("Flag activation").should("be.visible").click();
        ...
        cy.url().should(
          "include",
          "/dashboard/projects/1/flags/1/webhooks?newWebhook=true"
        );
