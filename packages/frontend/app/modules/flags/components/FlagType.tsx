...
export const FlagTypeBadge = ({ type }: FlagTypeBadgeProps) => {
  if (type === FlagType.RELEASE) {
    return (
      <div className="inline-block">
        <Tag className="bg-violet-100 dark:bg-violet-100 text-violet-700 dark:text-violet-700 flex flex-row gap-2 items-center">
  ...
  if (type === FlagType.EXPERIMENT) {
    return (
      <div className="inline-block">
        <Tag className="bg-teal-100 dark:bg-teal-100 text-teal-700 dark:text-teal-700 flex flex-row gap-2 items-center">
  ...
  if (type === FlagType.PERMISSION) {
    return (
      <div className="inline-block">
        <Tag className="bg-orange-100 dark:bg-orange-100 text-orange-700 dark:text-orange-700 flex flex-row gap-2 items-center">
  ...
  if (type === FlagType.KILL_SWITCH) {
    return (
      <div className="inline-block">
        <Tag className="bg-stone-100 dark:bg-stone-100 text-stone-700 dark:text-stone-700 flex flex-row gap-2 items-center">
